...
## Project Structure
    ...
    ├── atcws_command_cente_37780  # Django project configurations
...
1. Clone this repo and `cd atcws_command_cente_37780`
...
2. Clone this repo and `cd atcws_command_cente_37780`
